...
class ActorByMembershipTest extends Specification {

    def ActorByMembership filter
    ...
    def should_throw_exception_if_mandatory_input_is_not_positive_integer() {
        ...
        filter.setInputParameters([(ActorByMembership.MAXIMUM_WORKLOAD_INPUT):-1])
    ...
    def should_return_a_list_of_candidates() {
        ...
        filter.setInputParameters([(ActorByMembership.MAXIMUM_WORKLOAD_INPUT):'3'])
