...
@Slf4j
class ActorByMembership extends AbstractUserFilter {
    
    def static final MAXIMUM_WORKLOAD_INPUT = "maximumWorkload"
    
    /**
     * Perform validation on the inputs defined on the actorfilter definition (src/main/resources/actorByMembership.def)
     * You should:
